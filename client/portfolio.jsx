...
const PortfolioList = (props) => {
    ...
    const portfolioNodes = portfolioPieces.map(piece => {
        return (
            <div key={piece.id} className='project flex flex-col w-2/3 content-center items-center border-0 rounded-2xl p-2 py-4 drop-shadow-lg hover:drop-shadow-xl transition duration-200 bg-gradient-to-tl from-violet-800 to-violet-900'>
                ...
                <p className='projectDesc text-center py-2 text-slate-300'>{piece.description}</p>
